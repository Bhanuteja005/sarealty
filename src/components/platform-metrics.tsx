            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-4">
                    <AnimationContainer animation="fadeUp" delay={0.2}>
                        <SectionBadge title="Our Success" />
                    </AnimationContainer>
                    ...
                    <AnimationContainer animation="fadeUp" delay={0.4}>
                        <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
                            Experience the difference with proven expertise and personalized service.
                        </p>
                    </AnimationContainer>
                ...
                <div className="flex flex-col gap-6 px-1 md:px-0">
                    {METRICS.map((metric, index) => (
                        <AnimationContainer
                            ...
                            delay={0.6 + (index * 0.2)}
                        >
                            <div className="relative rounded-3xl bg-card p-4 lg:p-6 overflow-hidden z-0 shadow-sm">
