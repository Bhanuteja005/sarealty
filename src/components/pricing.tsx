            ...
            <div className="flex flex-col items-center text-center gap-4">
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
                        Discover our service options designed to meet your real estate goals
                    </p>
                </AnimationContainer>
            </div>
            ...
            <AnimationContainer animation="fadeUp" delay={0.5}>
                <div className="flex items-center justify-center gap-4 pt-10">
                    ...
                    >
                        <div
                            className={cn(
                                "h-4 w-4 rounded-full bg-gradient-to-b from-primary to-fuchsia-400 transition-transform duration-300",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-10">
                {PRICING_PLANS.map((plan, index) => (
                    ...
                    >
                        <div
                            className={cn(
                                "relative rounded-3xl p-8 flex flex-col overflow-hidden bg-card",
