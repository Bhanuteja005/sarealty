            ...
            <div className="flex flex-col items-center text-center gap-4 py-8 w-full">
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-lg mx-auto">
                        Our proven three-step approach ensures a smooth and successful real estate experience.
                    </p>
                </AnimationContainer>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 w-full pt-10">
                {HOW_IT_WORKS.map((item, index) => (
                    ...
                    >
                        <div
                            className={cn(
                                "flex flex-col items-start gap-4 rounded-lg lg:rounded-2xl p-4 lg:p-8 bg-card border border-border hover:shadow-lg transition-transform transform hover:-translate-y-1",
                                    index % 2 === 0 ? "" : ""
                            )}
                        >
                            <div className="flex items-center gap-x-4">
                                <AnimationContainer
                                    ...
                                    delay={0.7 + (index * 0.2)}
                                >
                                    <div className="size-10 rounded-full bg-gradient-to-b from-primary to-fuchsia-400 flex items-center justify-center">
